    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        callback = function(args)
          ...
          vim.keymap.set('n', '<leader>vc', vim.lsp.buf.code_action, { buffer = 0 })
          vim.keymap.set('n', '<leader>vp', require('actions-preview').code_actions, { buffer = 0 })
          vim.keymap.set('n', '<leader>vn', vim.lsp.buf.rename, { buffer = 0 })
          vim.keymap.set('n', '<leader>vs', builtin.lsp_document_symbols, { buffer = 0 })

          vim.keymap.set('n', '<leader>f', function() vim.lsp.buf.format({ async = false, timeout_ms = 10000 }) end, { buffer = 0 })
